return {
    ...
    config = function()
        ...
        -- split window
        vim.keymap.set("n", "<leader><C-h>", "<cmd>vsplit<CR> <cmd>enew<CR>", { noremap = true, silent = true })
        vim.keymap.set("n", "<leader><C-j>", "<cmd>split<CR> <C-w>j <cmd>enew<CR>", { noremap = true, silent = true })
        vim.keymap.set("n", "<leader><C-k>", "<cmd>split<CR> <cmd>enew<CR>", { noremap = true, silent = true })
