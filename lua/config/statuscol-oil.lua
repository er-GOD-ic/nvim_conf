            ...
            if entry and entry.name then
                ...
                if dir then
                    ...
                    if stat and stat.size then
                        return format_number(stat.size, M.opts.size_width, M.opts.prefer_units)
                    end
                end
            end
            return string.rep("-", M.opts.size_width)
        end,
    },
    hl = "NonText"
}
            ...
            if entry and entry.name then
                ...
                if dir then
                    ...
                    if stat and stat.mtime then
                        return format_time(stat.mtime.sec, M.opts.mtime_format)
                    end
                end
            end
            return "xxx"
...
local function groupname_from_gid(gid)
